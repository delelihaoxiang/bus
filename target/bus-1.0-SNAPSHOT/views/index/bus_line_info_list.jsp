...
<div class="layui-container">
  ...
  <div carousel-item="">
  	...
  	<div><a href="#"><img src="${item.bannerImg}" style="width:1170px;height:240px"></a></div>
  	</c:forEach>
      ...
      <div class="layui-row">
        <div class="layui-col-xs6 layui-col-sm6 layui-col-md6" style="padding:6px;">
    		<label class="layui-form-label">搜索线路</label>
    		<div class="layui-input-block">
     			<input type="text" name="searchWord" id="searchWord" placeholder="请输入搜索线路名"  class="layui-input">
    		</div>
  		</div>
  	...
  	$.ajax({
  				...
  				success : function(result) {
  					...
  					for (var i = 0; i < rows.length; i++) {
							...
							html+='<h2>';
							html+=' <a href="#">'+rows[i].t.lineName+'</a>';
							html+=' </h2>';
							html+=' <div class="fly-list-info">';
							var bl2 = rows[i].bl2;
							var str='';
							for(var j=0;j<bl2.length;j++){
								str+=bl2[j].createTime+'-->';
							}
							if(str!=''){
								str = str.substring(0,str.length-3);
							}
							html+='<p>路线：'+str+'</p>';
							html+='<p>费用：'+rows[i].t.price+'</p>';
							html+='</div>';
