...
function ajaxList(page) {
  	...
  	$.ajax({
  				type : 'post',
  				url : "${pageContext.request.contextPath}/commonapi/index/news_info/search",
  				data : {
  				...
  				success : function(result) {
  					...
  					for (var i = 0; i < rows.length; i++) {
   		              		html+=' <li>';
	html+='<h2>';
	html+=' <a href="${pageContext.request.contextPath}/commonapi/index/news_info/detail?id='+rows[i].t.id+'">'+rows[i].t.title+'</a>';
	html+=' </h2>';
