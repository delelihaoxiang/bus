                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <nav class="breadcrumb"><i class="Hui-iconfont"></i>公交线路<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
                                    <div class="page-container">
                                    
                                    <div style="display:inline;margin-top:30px"><span style="width:200px;margin-left:50px;">路线名</span>
                                    <input type="text" class="input-text"  style="width:250px;display:inline"  placeholder="请输入路线名进行查询" id="lineName">
                                    </div>
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/bus_line_info/add" class="btn btn-success radius">新增</a>
                                        ...
                                        <tbody id="bus_line_info_body">
                                        </tbody>
                                        </table>
                                        
                                        <div id="bus_line_info_bar" class="pagination" style="margin-top:20px;">
                                        </div>
                                        <div>
                                        </div>
                                        </div>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui/js/H-ui.min.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                ...
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0462"></script>
                                                                    ...
                                                                    function ajaxList(page) {
                                                                        ...
                                                                        showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                            $.ajax({
                                                                                type : 'post',
                                                                                url : "${pageContext.request.contextPath}/admin/bus_line_info/queryList",
                                                                                    data : {
                                                                                        "page":page,
                                                                                        "lineName":lineName
                                                                                    ...
                                                                                    success : function(result) {
                                                                                        ...
                                                                                        for (var i = 0; i < rows.length; i++) {
                                                                                            html += '<tr>' ;
                                                                                            var lineNameVal=setNullToEmpty(rows[i].busLineInfo.lineName);
                                                                                            html+='<td>'+ lineNameVal+'</td>';
                                                                                            var priceVal=setNullToEmpty(rows[i].busLineInfo.price);
                                                                                            html+='<td>'+ priceVal+'</td>';
                                                                                            html+='<td>';
                                                                                            html+='<a href="${pageContext.request.contextPath}/admin/bus_line_info/update?id='+rows[i].busLineInfo.id+'" class="btn btn-primary  radius btnStyle">修改</a>';
                                                                                                html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].busLineInfo.id+'" class="btn btn-danger  radius btnStyle">删除</a>';
                                                                                                html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/admin/bus_line_msg_info?lineId='+rows[i].busLineInfo.id+'" page-name="路线-车站关联" onclick="gotoPage(this)"  class="btn btn-success radius btnStyle">管理具体路线</a>';
                                                                                                    html+='</td>';
                                                                                                    html+='</tr>';
                                                                                                }
                                                                                                if (rows.length == 0) {
                                                                                                ...
                                                                                                $("#bus_line_info_body").html(html);
                                                                                                
                                                                                                
                                                                                                new myPagination({
                                                                                                    id: 'bus_line_info_bar',
                                                                                                    curPage:page, //初始页码
                                                                                    ...
                                                                                    function del(e){
                                                                                        if(window.confirm('你确定要删除该公交线路吗')){
                                                                                            var id = $(e).attr("data-id");
                                                                                            $.ajax({
                                                                                                type : 'get',
                                                                                                url : "${pageContext.request.contextPath}/admin/bus_line_info/del",
                                                                                                    data : {
                                                                                                        "id":id
                                                                                                    },
                                                                                                    success : function(result) {
