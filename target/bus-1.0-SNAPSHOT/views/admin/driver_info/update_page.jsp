                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/default/skin.css" id="skin" />
                                    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                        ...
                                        <input type="text" class="input-text"  style="width:500px;display:inline" value="${data.realName}" placeholder="请输入姓名" id="realName">
                                            ...
                                            <div class="formControls col-xs-8 col-sm-9">
                                            <input type="text" class="input-text"  style="width:500px;display:inline" value="${data.celPhone}" placeholder="请输入联系电话" id="celPhone">
                                                </div>
                                                </div>
                                                
                                                <div class="row cl" id="driverIntroParentContent" style="margin-top:20px;margin-left:20px;" >
                                                <label class="form-label col-xs-4 col-sm-2">
                                                司机简介
                                                </label>
                                                <div class="formControls col-xs-8 col-sm-9">
                                                <textarea  placeholder="请输入司机简介"  id="driverIntro"  rows="15" cols="100">${data.driverIntro}</textarea>
                                                    </div>
                                                    </div>
                                                        ...
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/layer/2.4/layer.js"></script>
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui/js/H-ui.min.js"></script>
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer /作为公共模版分离出去-->
                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1724"></script>
                                                                        ...
                                                                        function submitData(){
                                                                            ...
                                                                            var driverIntro= $('#driverIntro').val();
                                                                            
                                                                            $.ajax({
                                                                                type: 'post',
                                                                                url: '${pageContext.request.contextPath}/admin/driver_info/update_submit',
                                                                                    data:{
                                                                                        "id":'${data.id}',
                                                                                            "realName":realName,
                                                                                            "celPhone":celPhone,
