                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <nav class="breadcrumb"><i class="Hui-iconfont"></i>司机<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/driver_info/add" class="btn btn-success radius">新增</a>
                                        ...
                                        <tbody id="driver_info_body">
                                        </tbody>
                                        </table>
                                        
                                        <div id="driver_info_bar" class="pagination" style="margin-top:20px;">
                                        </div>
                                        <div>
                                        </div>
                                        </div>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui/js/H-ui.min.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                ...
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4406"></script>
                                                                    ...
                                                                    function ajaxList(page) {
                                                                        ...
                                                                        showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                            $.ajax({
                                                                                type : 'post',
                                                                                url : "${pageContext.request.contextPath}/admin/driver_info/queryList",
                                                                                    data : {
                                                                                        "page":page,
                                                                                        "realName":realName
                                                                                    ...
                                                                                    success : function(result) {
                                                                                        ...
                                                                                        for (var i = 0; i < rows.length; i++) {
                                                                                            html += '<tr>' ;
                                                                                            var realNameVal=setNullToEmpty(rows[i].driverInfo.realName);
                                                                                            html+='<td>'+ realNameVal+'</td>';
                                                                                            var celPhoneVal=setNullToEmpty(rows[i].driverInfo.celPhone);
                                                                                            html+='<td>'+ celPhoneVal+'</td>';
                                                                                            var driverIntroVal=setNullToEmpty(rows[i].driverInfo.driverIntro);
                                                                                            html+='<td>'+ driverIntroVal+'</td>';
                                                                                            html+='<td>';
                                                                                            html+='<a href="${pageContext.request.contextPath}/admin/driver_info/update?id='+rows[i].driverInfo.id+'" class="btn btn-primary  radius btnStyle">修改</a>';
                                                                                                html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].driverInfo.id+'" class="btn btn-danger  radius btnStyle">删除</a>';
                                                                                                html+='</td>';
                                                                                                html+='</tr>';
                                                                                            }
                                                                                            if (rows.length == 0) {
                                                                                ...
                                                                                function del(e){
                                                                                    if(window.confirm('你确定要删除该司机吗')){
                                                                                        var id = $(e).attr("data-id");
                                                                                        $.ajax({
                                                                                            type : 'get',
                                                                                            url : "${pageContext.request.contextPath}/admin/driver_info/del",
                                                                                                data : {
                                                                                                    "id":id
                                                                                                },
                                                                                                success : function(result) {
