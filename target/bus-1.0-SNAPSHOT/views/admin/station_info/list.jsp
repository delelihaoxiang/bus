                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <nav class="breadcrumb"><i class="Hui-iconfont"></i>车站<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
                                    <div class="page-container">
                                    
                                    <div style="display:inline;margin-top:30px"><span style="width:200px;margin-left:50px;">车站名</span>
                                    <input type="text" class="input-text"  style="width:250px;display:inline"  placeholder="请输入车站名进行查询" id="stationName">
                                    </div>
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/station_info/add" class="btn btn-success radius">新增</a>
                                        ...
                                        <tbody id="station_info_body">
                                        </tbody>
                                        </table>
                                        
                                        <div id="station_info_bar" class="pagination" style="margin-top:20px;">
                                        </div>
                                        <div>
                                        </div>
                                        </div>
                                                                ...
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8824"></script>
                                                                    ...
                                                                    function ajaxList(page) {
                                                                        ...
                                                                        showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                            $.ajax({
                                                                                type : 'post',
                                                                                url : "${pageContext.request.contextPath}/admin/station_info/queryList",
                                                                                    data : {
                                                                                        "page":page,
                                                                                    ...
                                                                                    success : function(result) {
                                                                                        ...
                                                                                        for (var i = 0; i < rows.length; i++) {
                                                                                            html += '<tr>' ;
                                                                                            var stationNameVal=setNullToEmpty(rows[i].stationInfo.stationName);
                                                                                            html+='<td>'+ stationNameVal+'</td>';
                                                                                            html+='<td>';
                                                                                            html+='<a href="${pageContext.request.contextPath}/admin/station_info/update?id='+rows[i].stationInfo.id+'" class="btn btn-primary  radius btnStyle">修改</a>';
                                                                                                html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].stationInfo.id+'" class="btn btn-danger  radius btnStyle">删除</a>';
                                                                                                html+='</td>';
                                                                                                html+='</tr>';
                                                                                            }
                                                                                            if (rows.length == 0) {
                                                                                ...
                                                                                function del(e){
                                                                                    if(window.confirm('你确定要删除该车站吗')){
                                                                                        var id = $(e).attr("data-id");
                                                                                        $.ajax({
                                                                                            type : 'get',
                                                                                            url : "${pageContext.request.contextPath}/admin/station_info/del",
                                                                                                data : {
                                                                                                    "id":id
                                                                                                },
                                                                                                success : function(result) {
