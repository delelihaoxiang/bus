                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <nav class="breadcrumb"><i class="Hui-iconfont"></i>用户建议<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
                                    ...
                                    <c:forEach items="${isDealList}" var="item">
                                        <option value="${item.id}">${item.name}</option>
                                            ...
                                            <a href="${pageContext.request.contextPath}/user/advice_info/add" class="btn btn-success radius">我要反馈</a>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui/js/H-ui.min.js"></script>
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                        ...
                                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8569"></script>
                                                                            ...
                                                                            function ajaxList(page) {
                                                                                ...
                                                                                showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                                    $.ajax({
                                                                                        type : 'get',
                                                                                        url : "${pageContext.request.contextPath}/user/advice_info/queryList",
                                                                                            data : {
                                                                                                "page":page,
                                                                                                "isDeal":isDeal
                                                                                            ...
                                                                                            success : function(result) {
                                                                                                ...
                                                                                                for (var i = 0; i < rows.length; i++) {
                                                                                                    ...
                                                                                                    html+='<td>';
                                                                                                    if(rows[i].adviceInfo.isDeal=='1'){
                                                                                                        html+='<a href="${pageContext.request.contextPath}/user/advice_info/update?id='+rows[i].adviceInfo.id+'" class="btn btn-primary  radius btnStyle">修改</a>';
                                                                                                        }
                                                                                                        if(rows[i].adviceInfo.isDeal=='1'){
                                                                                                            html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].adviceInfo.id+'" class="btn btn-danger  radius btnStyle">删除</a>';
                                                                                                        }
                                                                                                        html+='</td>';
                                                                                                        html+='</tr>';
                                                                                                    }
                                                                                        ...
                                                                                        function del(e){
                                                                                            if(window.confirm('你确定要删除该用户建议吗')){
                                                                                                var id = $(e).attr("data-id");
                                                                                                $.ajax({
                                                                                                    type : 'get',
                                                                                                    url : "${pageContext.request.contextPath}/user/advice_info/del",
                                                                                                        data : {
                                                                                                            "id":id
                                                                                                        },
                                                                                                        success : function(result) {
